...
export default function Tarjeta({ id, image, name, price, lastProduct }) {
	...
	return (
		<div
			...
			key={id}
			className="flex bg-white p-10 font-mono border-b-2"
		>
			...
			<div className="flex-auto pb-2 pl-6">
				<div className="flex w-[830px] rounded flex-wrap items-baseline mb-4 pb-4 before:bg-white shadow-xl">
					...
					<div className="relative text-lg text-black p-2 rounded-2xl">
						${price}
					</div>
