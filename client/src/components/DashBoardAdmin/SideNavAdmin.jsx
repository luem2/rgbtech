        ...
        <nav className="col-span-2 border-r border-gray-300 min-h-[90vh] w-[50px] xl:w-[180px] pt-8 px-1 flex flex-col items-start justify-between">
          <div className="space-y-4 w-full ">
                ...
                <button onClick={()=>selection("Dashboard")} 
                        className="bg-[#87CEFA] text-white p-2 rounded-xl w-full hover:scale-95 hover:bg-blue-600"> Dashboard</button>
            
            <div className="w-full border-t pt-7 border-gray-300" />
            
                <button onClick={()=>selection("Users")} 
                        className="w-full bg-[#87CEFA] text-white p-2 rounded-xl hover:scale-95 hover:bg-blue-600"> Users</button>

             <div className="w-full border-t pt-7 border-gray-300" />

                <button onClick={()=>selection("Products")} 
                        className="w-full bg-[#87CEFA] text-white p-2 rounded-xl hover:scale-95 hover:bg-blue-600"> Products</button>
             <div className="w-full border-t pt-7 border-gray-300" />

                <button onClick={()=>selection("tags/brands")} 
                        className="w-full bg-[#87CEFA] text-white p-2 rounded-xl hover:scale-95 hover:bg-blue-600"> Tags/Brands</button>
             <div className="w-full border-t pt-7 border-gray-300" />

                <button onClick={()=>selection("AddProducts")} 
                        className="w-full bg-[#87CEFA] text-white p-2 rounded-xl hover:scale-95 hover:bg-blue-600"> Add products </button>
