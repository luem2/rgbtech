...
import LoguinGoogle from './Buttons/LoguinGoogle'
...
const Login = ({ closeModal }) => {
    ...
    return (
        <div className='flex overflow-x-hidden overflow-y-auto fixed inset-0 z-50 text-black'>
            <div className='relative w-auto my-20 mx-auto max-w-3xl'>
                <div>
                    <div className='flex items-center lg:justify-center'>
                        <div className='flex flex-row overflow-hidden bg-white rounded-md shadow-lg max md:flex-row md:flex-1 lg:max-w-screen-md sm:flex-col'>
                            <div className='p-4 py-6 text-white bg-pink-500 md:w-80 md:flex-shrink-0 md:flex md:flex-col md:items-center md:justify-evenly'>
                                <div className='flex flex-col justify-center items-center my-3 text-4xl font-bold tracking-wider text-center'>
                                    <span className='sm:hidden'>RGBTech</span>
                                    <img
                                        className='w-40 pt-4 sm:-mt-8'
                                        src={logo}
                                        alt='logo-rgbtech'
                                    />
                                </div>
                                <p className='mt-6 font-normal text-center text-gray-300 md:mt-0 sm:hidden'>
                                    Buy the best products, at the best price
                                    available. At rgbtech, you will find
                                    everything you want..
                                </p>
