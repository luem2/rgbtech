			...
			>
				<div className="l-20">
					<SwiperSlide className="flex justify-center items-center h-screen">
						<img className="w-auto h-[500px] mb-8" src={imagnaryProducts[0]} />
						{/* <img
					...
					<SwiperSlide className="flex justify-center items-center">
						<img className="w-auto h-[500px]" src={imagnaryProducts[1]} />
						{/* <img
					...
					<SwiperSlide className="flex justify-center items-center">
						<img className="w-auto h-[500px]" src={imagnaryProducts[2]} />
						{/* <img
							className="hidden w-screen h-[300px] sm:flex"
					...
					<SwiperSlide className="flex justify-center items-center">
						<img className="w-auto h-[500px]" src={imagnaryProducts[3]} />
						{/* <img
							className="hidden w-screen h-[300px] sm:flex"
					...
					<SwiperSlide className="flex justify-center items-center">
						<img className="w-auto h-[500px]" src={imagnaryProducts[4]} />
						{/* <img
							className="hidden w-screen h-[300px] sm:flex"
					...
					<SwiperSlide className="flex justify-center items-center">
						<img className="w-auto h-[500px]" src={imagnaryProducts[5]} />
						{/* <img
							className="hidden w-screen h-[300px] sm:flex"
					...
					<SwiperSlide className="flex justify-center items-center">
						<img className="w-auto h-[500px]" src={imagnaryProducts[6]} />
						{/* <img
							className="hidden w-screen h-[300px] sm:flex"
					...
					<SwiperSlide className="flex justify-center items-center">
						<img className="w-auto h-[500px]" src={imagnaryProducts[7]} />
						{/* <img
							className="hidden w-screen h-[300px] sm:flex"
