  ...
  return (
    <>
      ...
      {showModal ? (
        <>
          <div
            className="justify-center items-center fixed inset-0 z-50 outline-none focus:outline-none"
          >
       ...
       {/* <div className="grow-0 shrink-0 basis-auto block lg:flex w-full lg:w-6/12 xl:w-4/12">
        ...
        <div className="grow-0 shrink-0 basis-auto w-full">
            <div className="absolute flex justify-end right-7 mt-1">
                <button className=" rounded-full" onClick={() => setShowModal(false)}><AiOutlineClose size={30}/></button>
            </div>
          <div className="px-6 py-12 md:px-12">
            <h2 className="text-3xl text-pink-500 font-bold mb-6 pb-2">welcome to RGBTech</h2>
